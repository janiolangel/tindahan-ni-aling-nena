...
<body>
    <div class="container">
        ...
        <aside class="nav-tabs">
            ...
            <a href='?store_id=<?php echo $_SESSION['store_id']?>&view=tags' class="nav-tab <?php echo ($_SESSION['store_view'] == 'tags')? 'active':''; ?>">Tags</a>
            <a href='?store_id=<?php echo $_SESSION['store_id']?>&view=suki' class="nav-tab <?php echo ($_SESSION['store_view'] == 'suki')? 'active':''; ?>">Suki</a>
        </aside>
        
        <div class="content-area">
            <?php if ($_SESSION['store_view'] == 'summary'): ?>
                <aside class="store-item item-card">
            ...
            <?php elseif ($_SESSION['store_view'] == 'products'): ?>
                <aside class="store-item item-card">
                    <?php foreach ($products as $product): ?>
                        ...
                        <a href="operations/edit_product.php?stock_id=<?php echo $product['stock_id'];?>" class="btn btn-edit">Edit</a>
                        <a href="operations/delete_product.php?stock_id=<?php echo $product['stock_id'];?>" class="btn btn-delete">Delete</a>
                        <br>
                    <?php endforeach;?>
                </aside>
                <a href="operations/add_product.php?store_id=<?php echo $_SESSION['store_id']?>" class="btn add-product">Add Product +</a>
            <?php elseif ($_SESSION['store_view'] == 'invoice'): ?>
                <aside class="store-item item-card">
                    ...
                    <?php foreach ($invoices as $invoice): ?>
                        ...
                        <a href="operations/edit_invoice.php?stock_id=<?php echo $product['stock_id'];?>" class="btn btn-edit">Edit</a>
                        <a href="operations/delete_invoice.php?stock_id=<?php echo $product['stock_id'];?>" class="btn btn-delete">Delete</a>
                        <br>
                    <?php endforeach;?>
                </aside>
                <a href="operations/add_invoice.php?store_id=<?php echo $_SESSION['store_id']?>" class="btn add-invoice">Add Invoice +</a>
            <?php endif;?>
            <div>
                <a href='dashboard.php' class="btn menu">Go Back to Stores</a>
            </div>
        </div>
    </div>
</body>
